        ...
        <!-- <li class="nav-item">
         ...
         <li class="nav-item">
            ...
            <div class="collapse" id="e-commerce">
             ...
             @foreach($m as $m)
                <li class="nav-item"> <a class="nav-link" href="/modules?promo={{$m->libelle}}"> Promo {{$m->libelle}} </a></li>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                 ...
                                 <!-- <button class="btn btn-light">
                                    ...
                                    <a href="{{ URL::to('notes',[ $f->id_mod,isset($_GET['promo'])]) }}"><button class="btn btn-light">
