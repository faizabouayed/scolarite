          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-transparent text-left p-5 text-center">
              <img src="../../images/faces/face13.jpg" class="lock-profile-img" alt="img">
                    {{-- message --}}
                    {!! Toastr::message() !!}
                    <h1 class="auth-title">Compte verouillé</h1>
                    <p class="auth-subtitle mb-5">Entrer votre mot de passe pour le deverouiller</p>
                    ...
                    @endif
                    <br>
                    <form method="POST" action="{{ route('unlockA') }}" class="md-float-material">
                        @csrf
