                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail3" placeholder="Email" value="{{$user->prenom}}">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword4">Date</label>
                      <input type="date" class="form-control" id="exampleInputPassword4" placeholder="Password" value="{{$user->date_n}}">
                    </div>
                    <div class="form-group">
