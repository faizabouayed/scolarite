                              ...
                              <div class="row align-items-center mb-3">
                                <form method="POST" action="{{ route('promotions.update',$promotion->id_pr) }}" class="sign-up-form" onsubmit="return userformcheck(this)">
                                  ...
                                  <div class="input-group-icon mb-3"> 
                                    ...
                                    <input id="anneeF" type="year" class="form-control form-little-squirrel-control @error('anneeF') is-invalid @enderror" placeholder="anneeF" name="anneeF" value="{{$promotion->annee_fin}}"  autocomplete="anneeF"  style="border-radius:5px; box-shadow:1px 1px 2px #C0C0C0 inset"  autofocus>
                                  </div>  
